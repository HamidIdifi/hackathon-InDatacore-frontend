...
@Component({
  selector: 'app-date-time-axis-graph',
  templateUrl: './date-time-axis-graph.component.html',
  styleUrls: ['./date-time-axis-graph.component.css']
})
export class DateTimeAxisGraphComponent implements OnInit {
